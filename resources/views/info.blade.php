...
@section('content')
    ...
    @guest
    <hr id="line">
    <div id="accesso_content">
        <h1>Registrati e acquista coupon</h1>
        <p>Per accedere alle funzionalità di acquisto dei coupon sul nostro sito, è necessario registrarsi compilando il modulo di registrazione, fornendo alcuni tuoi dati personali, che troverai cliccando su questo link <a class="register" href="{{route('register')}}"> Registrati </a></p>
    @endguest
    </div>