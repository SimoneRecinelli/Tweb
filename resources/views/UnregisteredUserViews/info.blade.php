...
@section('content')
    ...
    <div class="container-info">
        ...
        <div class="chisiamo_content">
            <h1>Chi siamo?</h1>
            <p>CheapestCoupon è un sito completamente gratuito dedicato a codici sconto, offerte e coupon nato nel 2023 come progetto universitario per il corso di Tecnologie Web. Ogni volta che effettui un acquisto su Internet, ti aiutiamo a risparmiare denaro.</p>
        ...
        @guest
        <div class="accesso_content">
            <h1>Registrati e acquista coupon</h1>
            <br>
            <p>Per accedere alle funzionalità di acquisto dei coupon sul nostro sito, è necessario registrarsi compilando il modulo di registrazione, fornendo alcuni tuoi dati personali, che troverai cliccando su questo bottone:</p>
            <a class="register" href="{{route('register')}}"> Registrati </a>
        </div>
        @endguest
